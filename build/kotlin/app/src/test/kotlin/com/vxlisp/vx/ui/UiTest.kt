    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          ...
          // [
            vx_ui_uiTest.f_boolean_writestate_from_uiapp_testdescribe_1(context)
          // ]
        )
      // ]
    )
          ...
          vx_core.f_let(
            ...
            vx_core.t_any_from_func.vx_fn_new(
              { ->
                ...
                val appui : vx_ui_ui.Type_ui = vx_ui_ui.f_ui_readstate_uiapp(context)
                val isremoved : vx_core.Type_boolean = vx_ui_ui.f_boolean_removestate_uiapp(context)
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_ui_uiTest.f_string_parentuid_from_uid_testdescribe_1(context),
            vx_ui_uiTest.f_string_parentuid_from_uid_testdescribe_2(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_ui_uiTest.f_ui_readstate_uiapp_testdescribe_1(context)
          // ]
        )
      // ]
    )
          ...
          vx_core.f_let(
            ...
            vx_core.t_any_from_func.vx_fn_new(
              { ->
                ...
                val output_1 : vx_core.Type_any = vx_ui_ui.f_ui_readstate_uiapp(context)
                output_1
              }
            )
          )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_ui_uiTest.f_ui_readstate_from_uid_testdescribe_1(context)
          // ]
        )
      // ]
    )
          ...
          vx_core.f_let(
            ...
            vx_core.t_any_from_func.vx_fn_new(
              { ->
                ...
                val iswrite : vx_core.Type_boolean = vx_ui_ui.f_boolean_writestate_from_uiapp(context, uiapp)
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_ui_uiTest.f_ui_write_from_ui_visible_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_ui_uiTest.f_ui_from_ui_find_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_ui_uiTest.f_ui_from_ui_selected_testdescribe_1(context)
          // ]
        )
      // ]
    )

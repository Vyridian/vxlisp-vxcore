    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          ...
          // [
            vx_web_htmlTest.f_string_from_body_indent_testdescribe_1(context),
            vx_web_htmlTest.f_string_from_body_indent_testdescribe_2(context)
          // ]
        )
      // ]
    )
      ...
      // [
        ...
        vx_test.f_test(
          ...
          vx_web_html.f_string_from_body_indent(
            vx_core.f_empty(vx_web_html.t_body),
          ...
          vx_web_html.f_string_from_body_indent(
            vx_core.f_new(
              ...
              vx_core.vx_new(
                vx_core.t_anylist,
                // [
                  vx_core.f_empty(vx_web_html.t_div)
                // ]
              )
            ),
            vx_core.vx_new_int(0)
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_web_htmlTest.f_string_from_div_indent_testdescribe_1(context),
            vx_web_htmlTest.f_string_from_div_indent_testdescribe_2(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_web_htmlTest.f_string_from_head_indent_testdescribe_1(context)
          // ]
        )
      // ]
    )
      ...
      // [
        ...
        vx_test.f_test(
          ...
          vx_web_html.f_string_from_head_indent(
            vx_core.f_empty(vx_web_html.t_head),
            vx_core.vx_new_int(0)
          )
        )
      // ]
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_web_htmlTest.f_string_from_html_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_web_htmlTest.f_string_from_img_indent_testdescribe_1(context),
            vx_web_htmlTest.f_string_from_img_indent_testdescribe_2(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_web_htmlTest.f_string_from_meta_indent_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_web_htmlTest.f_string_from_p_indent_testdescribe_1(context),
            vx_web_htmlTest.f_string_from_p_indent_testdescribe_2(context)
          // ]
        )
      // ]
    )

    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          ...
          // [
            TestVx.TranslateTest.f_translate_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TranslateTest.f_translate_1_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TranslateTest.f_translate_from_translation_string_testdescribe_1(context)
          // ]
        )
      // ]
    );

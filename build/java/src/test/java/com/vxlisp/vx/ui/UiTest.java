    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          ...
          // [
            UiTest.f_boolean_writestate_from_uiapp_testdescribe_1(context)
          // ]
        )
      // ]
    );
          ...
          Core.f_let(
            ...
            Core.t_any_from_func.vx_fn_new(
              () -> {
                ...
                final Core.Type_any output_1 = appui;
                return output_1;
              }
            )
          )
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            UiTest.f_string_parentuid_from_uid_testdescribe_1(context),
            UiTest.f_string_parentuid_from_uid_testdescribe_2(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            UiTest.f_ui_readstate_uiapp_testdescribe_1(context)
          // ]
        )
      // ]
    );
          ...
          Core.f_let(
            ...
            Core.t_any_from_func.vx_fn_new(
              () -> {
                ...
                final Core.Type_any output_1 = Ui.f_ui_readstate_uiapp(context);
                return output_1;
              }
            )
          )
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            UiTest.f_ui_readstate_from_uid_testdescribe_1(context)
          // ]
        )
      // ]
    );
          ...
          Core.f_let(
            ...
            Core.t_any_from_func.vx_fn_new(
              () -> {
                ...
                final Ui.Type_ui readval = Ui.f_ui_readstate_from_uid(
                  context,
                  Core.vx_new_string("a/b/c")
                );
                final Core.Type_boolean isremoved = Ui.f_boolean_removestate_uiapp(context);
                final Core.Type_any output_1 = readval;
                return output_1;
              }
            )
          )
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            UiTest.f_ui_write_from_ui_visible_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            UiTest.f_ui_from_ui_find_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            UiTest.f_ui_from_ui_selected_testdescribe_1(context)
          // ]
        )
      // ]
    );

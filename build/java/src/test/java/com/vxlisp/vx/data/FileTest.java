    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          ...
          // [
            FileTest.f_boolean_exists_from_file_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            FileTest.f_boolean_write_from_file_string_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            FileTest.f_file_read_from_file_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            FileTest.f_pathfull_from_file_testdescribe_1(context),
            FileTest.f_pathfull_from_file_testdescribe_2(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            FileTest.f_string_read_from_file_testdescribe_1(context)
          // ]
        )
      // ]
    );

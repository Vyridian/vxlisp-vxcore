...
public static class Tree {
  ...
  public class Class_branch : Vx.Core.Class_base, Type_branch {
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Tree.Type_branch output = Vx.Core.vx_copy(
        Vx.Data.Tree.e_branch,
        vals
      );
      return output;
    }
  ...
  public class Class_brancharrow : Vx.Core.Class_base, Type_brancharrow {
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Tree.Type_brancharrow output = Vx.Core.vx_copy(
        Vx.Data.Tree.e_brancharrow,
        vals
      );
      return output;
    }
  ...
  public class Class_branchlist : Vx.Core.Class_base, Type_branchlist {
    ...
    public List<Vx.Data.Tree.Type_branch> vx_p_list = Vx.Core.vx_listimmutable(
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Tree.Type_branchlist output = Vx.Core.vx_copy(
        Vx.Data.Tree.e_branchlist,
        vals
      );
      return output;
    }
  ...
  public class Class_leaf : Vx.Core.Class_base, Type_leaf {
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Tree.Type_leaf output = Vx.Core.vx_copy(
        Vx.Data.Tree.e_leaf,
        vals
      );
      return output;
  ...
  public class Class_leaflist : Vx.Core.Class_base, Type_leaflist {
    ...
    public List<Vx.Data.Tree.Type_leaf> vx_p_list = Vx.Core.vx_listimmutable(
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Tree.Type_leaflist output = Vx.Core.vx_copy(
        Vx.Data.Tree.e_leaflist,
        vals
      );
      return output;
    }
  ...
  public class Class_tree : Vx.Core.Class_base, Type_tree {
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Tree.Type_tree output = Vx.Core.vx_copy(
        Vx.Data.Tree.e_tree,
        vals
      );
      return output;

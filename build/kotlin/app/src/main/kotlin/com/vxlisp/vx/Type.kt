...
object vx_type {
  ...
  class Class_any_from_int : vx_core.Class_base, Func_any_from_int {
    ...
    override fun <T : vx_core.Type_any, U : vx_core.Type_any> vx_any_from_any(generic_any_1 : T, value : U) : T {
      ...
      val outputval : vx_core.Type_any = vx_type.f_any_from_int(
        vx_core.t_any,
        inputval
      )
      output = vx_core.f_any_from_any(
    ...
    override fun vx_repl(arglist : vx_core.Type_anylist) : vx_core.Type_any {
      ...
      val value : vx_core.Type_int = vx_core.f_any_from_any(
        vx_core.t_int,
        arglist.vx_any(
          vx_core.vx_new_int(0)
        )
  ...
  class Class_boolean_from_string_ends : vx_core.Class_base, Func_boolean_from_string_ends {
    ...
    override fun vx_repl(arglist : vx_core.Type_anylist) : vx_core.Type_any {
      ...
      val ends : vx_core.Type_string = vx_core.f_any_from_any(
        vx_core.t_string,
        arglist.vx_any(
  ...
  class Class_boolean_from_string_starts : vx_core.Class_base, Func_boolean_from_string_starts {
    ...
    override fun vx_repl(arglist : vx_core.Type_anylist) : vx_core.Type_any {
      ...
      val starts : vx_core.Type_string = vx_core.f_any_from_any(
        vx_core.t_string,
        arglist.vx_any(
          vx_core.vx_new_int(1)
        )
  ...
  class Class_int_from_string_findlast : vx_core.Class_base, Func_int_from_string_findlast {
    ...
    override fun vx_repl(arglist : vx_core.Type_anylist) : vx_core.Type_any {
      ...
      val findlast : vx_core.Type_string = vx_core.f_any_from_any(
        vx_core.t_string,
        arglist.vx_any(
          vx_core.vx_new_int(1)
        )
  ...
  class Class_is_type_from_any_typelist : vx_core.Class_base, Func_is_type_from_any_typelist {
    ...
    override fun vx_repl(arglist : vx_core.Type_anylist) : vx_core.Type_any {
      ...
      val typelist : vx_core.Type_typelist = vx_core.f_any_from_any(
        vx_core.t_typelist,
        arglist.vx_any(
          vx_core.vx_new_int(1)
        )
  ...
  fun f_is_type_from_any_typelist(value : vx_core.Type_any, typelist : vx_core.Type_typelist) : vx_core.Type_boolean {
    ...
    output = vx_core.f_any_from_list_start_reduce(
      ...
      vx_core.t_any_from_reduce.vx_fn_new(
        {result_any : vx_core.Type_any, type_any : vx_core.Type_any ->
          val result : vx_core.Type_boolean = vx_core.f_any_from_any(
            vx_core.t_boolean,
            result_any
          )
          val type : vx_core.Type_any = vx_core.f_any_from_any(
                      ...
                      var output_4 : vx_core.Type_any = vx_core.f_let(
                          ...
                          vx_core.t_any_from_func.vx_fn_new(
                            { ->
                              ...
                              val rest : vx_core.Type_string = vx_type.f_string_from_string_start(text, pos)
  ...
  class Class_string_from_string_end : vx_core.Class_base, Func_string_from_string_end {
    ...
    override fun vx_repl(arglist : vx_core.Type_anylist) : vx_core.Type_any {
      ...
      val endpos : vx_core.Type_int = vx_core.f_any_from_any(
        vx_core.t_int,
        arglist.vx_any(
          vx_core.vx_new_int(1)
        )
  ...
  class Class_string_from_string_start : vx_core.Class_base, Func_string_from_string_start {
    ...
    override fun vx_repl(arglist : vx_core.Type_anylist) : vx_core.Type_any {
      ...
      val startpos : vx_core.Type_int = vx_core.f_any_from_any(
        vx_core.t_int,
        arglist.vx_any(
          vx_core.vx_new_int(1)
        )
  ...
  class Class_string_from_stringlist_join : vx_core.Class_base, Func_string_from_stringlist_join {
    ...
    override fun vx_repl(arglist : vx_core.Type_anylist) : vx_core.Type_any {
      var output : vx_core.Type_any = vx_core.e_any
      val vals : vx_core.Type_stringlist = vx_core.f_any_from_any(
        vx_core.t_stringlist,
        arglist.vx_any(
          vx_core.vx_new_int(0)
        )
      )
      val delim : vx_core.Type_string = vx_core.f_any_from_any(
        vx_core.t_string,
        arglist.vx_any(
          vx_core.vx_new_int(1)
        )

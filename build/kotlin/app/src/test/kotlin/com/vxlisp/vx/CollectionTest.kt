    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          ...
          // [
            vx_collectionTest.f_minus_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_minus_1_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_any_from_for_until_loop_testdescribe_1(context)
          // ]
        )
      // ]
    )
          ...
          vx_collection.f_any_from_for_until_loop(
            ...
            vx_core.t_boolean_from_any.vx_fn_new(
              {current_any : vx_core.Type_any ->
                val current : vx_core.Type_int = vx_core.f_any_from_any(
                  vx_core.t_int,
                  current_any
                )
            ...
            vx_core.t_any_from_any.vx_fn_new(
              {current_any : vx_core.Type_any ->
                ...
                var output_2 : vx_core.Type_any = vx_core.f_plus(current, current)
                output_2
              }
            )
          )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_any_from_for_while_loop_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_anymap_from_struct_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_int_from_map_key_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_int_from_stringlist_find_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_is_list_testdescribe_1(context)
          // ]
        )
      // ]
    )
      ...
      // [
        ...
        vx_test.f_test_true(
          ...
          vx_collection.f_is_list(
            vx_core.f_empty(vx_core.t_stringlist)
          )
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_is_map_testdescribe_1(context)
          // ]
        )
      // ]
    )
      ...
      // [
        ...
        vx_test.f_test_true(
          ...
          vx_collection.f_is_map(
            vx_core.f_empty(vx_core.t_stringmap)
          )
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_list_from_for_end_loop_testdescribe_1(context)
          // ]
        )
      // ]
    )
      ...
      // [
        ...
        vx_test.f_test(
          ...
          vx_collection.f_list_from_for_end_loop(
            ...
            vx_core.t_any_from_int.vx_fn_new(
              {current_any : vx_core.Type_any ->
                val current : vx_core.Type_int = vx_core.f_any_from_any(
                  vx_core.t_int,
                  current_any
                )
                var output_1 : vx_core.Type_any = vx_core.f_multiply(current, current)
                output_1
              }
            )
          )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_list_from_list_end_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_list_from_list_filter_testdescribe_1(context)
          // ]
        )
      // ]
    )
                    ...
                    // [
                      vx_core.f_then(
                        vx_core.t_boolean_from_func.vx_fn_new(
                          { ->
                            var output_2 : vx_core.Type_any = vx_type.f_is_string(value)
                              output_2
                            }
                        ),
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_list_from_list_filtertypes_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_list_from_list_flatten_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_list_from_list_join_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_list_from_list_join_1_testdescribe_1(context)
          // ]
        )
      // ]
    )
      ...
      // [
        ...
        vx_test.f_test(
          ...
          vx_collection.f_list_from_list_join_1(
            ...
            vx_core.t_any_from_any.vx_fn_new(
              {values_any : vx_core.Type_any ->
                val values : vx_core.Type_stringlist = vx_core.f_any_from_any(
                  vx_core.t_stringlist,
                  values_any
                )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_list_from_list_start_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_list_from_list_start_end_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_map_from_map_end_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_map_from_map_keys_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_map_from_map_start_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_map_from_map_start_end_testdescribe_1(context)
          // ]
        )
      // ]
    )
    ...
    val output : vx_test.Type_testcase = vx_core.vx_new(
      ...
      // [
        ...
        vx_core.vx_new(
          vx_test.t_testdescribelist,
          // [
            vx_collectionTest.f_map_from_struct_testdescribe_1(context)
          // ]
        )
      // ]
    )

    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          ...
          // [
            TestVx.Web.HtmlTest.f_string_from_body_indent_testdescribe_1(context),
            TestVx.Web.HtmlTest.f_string_from_body_indent_testdescribe_2(context)
          // ]
        )
      // ]
    );
      ...
      // [
        ...
        Vx.Test.f_test(
          ...
          Vx.Web.Html.f_string_from_body_indent(
            Vx.Core.f_empty(Vx.Web.Html.t_body),
          ...
          Vx.Web.Html.f_string_from_body_indent(
            Vx.Core.f_new(
              ...
              Vx.Core.vx_new(
                Vx.Core.t_anylist,
                // [
                  Vx.Core.f_empty(Vx.Web.Html.t_div)
                // ]
              )
            ),
            Vx.Core.vx_new_int(0)
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Web.HtmlTest.f_string_from_div_indent_testdescribe_1(context),
            TestVx.Web.HtmlTest.f_string_from_div_indent_testdescribe_2(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Web.HtmlTest.f_string_from_head_indent_testdescribe_1(context)
          // ]
        )
      // ]
    );
      ...
      // [
        ...
        Vx.Test.f_test(
          ...
          Vx.Web.Html.f_string_from_head_indent(
            Vx.Core.f_empty(Vx.Web.Html.t_head),
            Vx.Core.vx_new_int(0)
          )
        )
      // ]
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Web.HtmlTest.f_string_from_html_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Web.HtmlTest.f_string_from_img_indent_testdescribe_1(context),
            TestVx.Web.HtmlTest.f_string_from_img_indent_testdescribe_2(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Web.HtmlTest.f_string_from_meta_indent_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Web.HtmlTest.f_string_from_p_indent_testdescribe_1(context),
            TestVx.Web.HtmlTest.f_string_from_p_indent_testdescribe_2(context)
          // ]
        )
      // ]
    );

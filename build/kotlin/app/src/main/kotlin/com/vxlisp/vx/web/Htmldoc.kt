...
object vx_web_htmldoc {
  ...
  class Class_boolean_print_from_id_stylesheettext : vx_core.Class_base, Func_boolean_print_from_id_stylesheettext {
    ...
    override fun vx_empty() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.e_boolean_print_from_id_stylesheettext
      return output
    }

    override fun vx_type() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.t_boolean_print_from_id_stylesheettext
      return output
    }

    override fun vx_repl(arglist : vx_core.Type_anylist) : vx_core.Type_any {
      var output : vx_core.Type_any = vx_core.e_any
      val id : vx_core.Type_string = vx_core.f_any_from_any(vx_core.t_string, arglist.vx_any(vx_core.vx_new_int(0)))
      val stylesheettext : vx_core.Type_string = vx_core.f_any_from_any(vx_core.t_string, arglist.vx_any(vx_core.vx_new_int(1)))
    ...
    override fun vx_boolean_print_from_id_stylesheettext(id : vx_core.Type_string, stylesheettext : vx_core.Type_string) : vx_core.Type_boolean {
      val output : vx_core.Type_boolean = vx_web_htmldoc.f_boolean_print_from_id_stylesheettext(id, stylesheettext)
      return output
    }
  ...
  class Class_boolean_remove_from_id : vx_core.Class_base, Func_boolean_remove_from_id {
    ...
    override fun vx_empty() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.e_boolean_remove_from_id
      return output
    }

    override fun vx_type() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.t_boolean_remove_from_id
      return output
    }
    ...
    override fun <T : vx_core.Type_any, U : vx_core.Type_any> vx_any_from_any(generic_any_1 : T, value : U) : T {
      ...
      val outputval : vx_core.Type_any = vx_web_htmldoc.f_boolean_remove_from_id(inputval)
    ...
    override fun vx_boolean_remove_from_id(id : vx_core.Type_string) : vx_core.Type_boolean {
      val output : vx_core.Type_boolean = vx_web_htmldoc.f_boolean_remove_from_id(id)
      return output
    }
  ...
  class Class_boolean_replace_from_id_htmltext : vx_core.Class_base, Func_boolean_replace_from_id_htmltext {
    ...
    override fun vx_empty() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.e_boolean_replace_from_id_htmltext
      return output
    }

    override fun vx_type() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.t_boolean_replace_from_id_htmltext
      return output
    }
    ...
    override fun vx_repl(arglist : vx_core.Type_anylist) : vx_core.Type_any {
      var output : vx_core.Type_any = vx_core.e_any
      val id : vx_core.Type_string = vx_core.f_any_from_any(vx_core.t_string, arglist.vx_any(vx_core.vx_new_int(0)))
      val htmltext : vx_core.Type_string = vx_core.f_any_from_any(vx_core.t_string, arglist.vx_any(vx_core.vx_new_int(1)))
    ...
    override fun vx_boolean_replace_from_id_htmltext(id : vx_core.Type_string, htmltext : vx_core.Type_string) : vx_core.Type_boolean {
      val output : vx_core.Type_boolean = vx_web_htmldoc.f_boolean_replace_from_id_htmltext(id, htmltext)
      return output
    }
  ...
  class Class_boolean_replace_from_id_parent_htmltext : vx_core.Class_base, Func_boolean_replace_from_id_parent_htmltext {
    ...
    override fun vx_empty() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.e_boolean_replace_from_id_parent_htmltext
      return output
    }

    override fun vx_type() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.t_boolean_replace_from_id_parent_htmltext
      return output
    }
    ...
    override fun vx_repl(arglist : vx_core.Type_anylist) : vx_core.Type_any {
      var output : vx_core.Type_any = vx_core.e_any
      val id : vx_core.Type_string = vx_core.f_any_from_any(vx_core.t_string, arglist.vx_any(vx_core.vx_new_int(0)))
      val parent : vx_core.Type_string = vx_core.f_any_from_any(vx_core.t_string, arglist.vx_any(vx_core.vx_new_int(1)))
      val htmltext : vx_core.Type_string = vx_core.f_any_from_any(vx_core.t_string, arglist.vx_any(vx_core.vx_new_int(2)))
    ...
    override fun vx_boolean_replace_from_id_parent_htmltext(id : vx_core.Type_string, parent : vx_core.Type_string, htmltext : vx_core.Type_string) : vx_core.Type_boolean {
      val output : vx_core.Type_boolean = vx_web_htmldoc.f_boolean_replace_from_id_parent_htmltext(id, parent, htmltext)
      return output
    }
  ...
  class Class_boolean_write_stylesheet_from_string : vx_core.Class_base, Func_boolean_write_stylesheet_from_string {
    ...
    override fun vx_empty() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.e_boolean_write_stylesheet_from_string
      return output
    }

    override fun vx_type() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.t_boolean_write_stylesheet_from_string
      return output
    }
    ...
    override fun <T : vx_core.Type_any, U : vx_core.Type_any> vx_any_from_any_async(generic_any_1 : T, value : U) : CompletableFuture<T> {
      ...
      val future : CompletableFuture<vx_core.Type_boolean> = vx_web_htmldoc.f_boolean_write_stylesheet_from_string(inputval)
  ...
  class Class_boolean_write_from_id_attribute_value : vx_core.Class_base, Func_boolean_write_from_id_attribute_value {
    ...
    override fun vx_empty() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.e_boolean_write_from_id_attribute_value
      return output
    }

    override fun vx_type() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.t_boolean_write_from_id_attribute_value
      return output
    }
    ...
    override fun vx_repl(arglist : vx_core.Type_anylist) : vx_core.Type_any {
      var output : vx_core.Type_any = vx_core.e_any
      val id : vx_core.Type_string = vx_core.f_any_from_any(vx_core.t_string, arglist.vx_any(vx_core.vx_new_int(0)))
      val attribute : vx_core.Type_string = vx_core.f_any_from_any(vx_core.t_string, arglist.vx_any(vx_core.vx_new_int(1)))
      val value : vx_core.Type_string = vx_core.f_any_from_any(vx_core.t_string, arglist.vx_any(vx_core.vx_new_int(2)))
    ...
    override fun vx_boolean_write_from_id_attribute_value(id : vx_core.Type_string, attribute : vx_core.Type_string, value : vx_core.Type_string) : vx_core.Type_boolean {
      val output : vx_core.Type_boolean = vx_web_htmldoc.f_boolean_write_from_id_attribute_value(id, attribute, value)
      return output
    }
  ...
  class Class_boolean_write_from_id_htmltext : vx_core.Class_base, Func_boolean_write_from_id_htmltext {
    ...
    override fun vx_empty() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.e_boolean_write_from_id_htmltext
      return output
    }

    override fun vx_type() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.t_boolean_write_from_id_htmltext
      return output
    }
    ...
    override fun vx_boolean_write_from_id_htmltext(id : vx_core.Type_string, htmltext : vx_core.Type_string) : vx_core.Type_boolean {
      val output : vx_core.Type_boolean = vx_web_htmldoc.f_boolean_write_from_id_htmltext(id, htmltext)
      return output
    }
  ...
  class Class_boolean_write_from_id_visible : vx_core.Class_base, Func_boolean_write_from_id_visible {
    ...
    override fun vx_empty() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.e_boolean_write_from_id_visible
      return output
    }

    override fun vx_type() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.t_boolean_write_from_id_visible
      return output
    }
    ...
    override fun vx_repl(arglist : vx_core.Type_anylist) : vx_core.Type_any {
      var output : vx_core.Type_any = vx_core.e_any
      val id : vx_core.Type_string = vx_core.f_any_from_any(vx_core.t_string, arglist.vx_any(vx_core.vx_new_int(0)))
      val visible : vx_core.Type_boolean = vx_core.f_any_from_any(vx_core.t_boolean, arglist.vx_any(vx_core.vx_new_int(1)))
    ...
    override fun vx_boolean_write_from_id_visible(id : vx_core.Type_string, visible : vx_core.Type_boolean) : vx_core.Type_boolean {
      val output : vx_core.Type_boolean = vx_web_htmldoc.f_boolean_write_from_id_visible(id, visible)
      return output
    }
  ...
  class Class_boolean_write_from_stylesheet : vx_core.Class_base, Func_boolean_write_from_stylesheet {
    ...
    override fun vx_empty() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.e_boolean_write_from_stylesheet
      return output
    }

    override fun vx_type() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.t_boolean_write_from_stylesheet
      return output
    }
    ...
    override fun <T : vx_core.Type_any, U : vx_core.Type_any> vx_any_from_any_async(generic_any_1 : T, value : U) : CompletableFuture<T> {
      val inputval : vx_web_html.Type_stylesheet = vx_core.f_any_from_any(vx_web_html.t_stylesheet, value)
      val future : CompletableFuture<vx_core.Type_boolean> = vx_web_htmldoc.f_boolean_write_from_stylesheet(inputval)
      val output : CompletableFuture<T> = future as (CompletableFuture<T>)
      return output
    }
  ...
  fun f_boolean_write_from_stylesheet(stylesheet : vx_web_html.Type_stylesheet) : CompletableFuture<vx_core.Type_boolean> {
    ...
    output = vx_core.f_let_async(
      ...
      vx_core.t_any_from_func_async.vx_fn_new({ ->
        val text : vx_core.Type_string = vx_web_htmldoc.f_string_from_stylesheet(
          stylesheet
        )
        val future_iswrite : CompletableFuture<vx_core.Type_boolean> = vx_web_htmldoc.f_boolean_write_stylesheet_from_string(
          text
        )
        val output_1 : CompletableFuture<vx_core.Type_any> = vx_core.vx_async_from_async_fn(
          ...
          future_iswrite,
          {iswrite ->
            val output_2 : vx_core.Type_any = iswrite
            output_2
          }
        )
        output_1
  ...
  class Class_boolean_writeevents_from_ui : vx_core.Class_base, Func_boolean_writeevents_from_ui {
    ...
    override fun vx_empty() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.e_boolean_writeevents_from_ui
      return output
    }

    override fun vx_type() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.t_boolean_writeevents_from_ui
      return output
    }
    ...
    override fun <T : vx_core.Type_any, U : vx_core.Type_any> vx_any_from_any(generic_any_1 : T, value : U) : T {
      ...
      val outputval : vx_core.Type_any = vx_web_htmldoc.f_boolean_writeevents_from_ui(inputval)
      output = vx_core.f_any_from_any(generic_any_1, outputval)
      return output
    }
    ...
    override fun vx_boolean_writeevents_from_ui(ui : vx_ui_ui.Type_ui) : vx_core.Type_boolean {
      val output : vx_core.Type_boolean = vx_web_htmldoc.f_boolean_writeevents_from_ui(ui)
      return output
    }
  ...
  class Class_context_read : vx_core.Class_base, Func_context_read {
    ...
    override fun vx_empty() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.e_context_read
      return output
    }

    override fun vx_type() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.t_context_read
      return output
    }
    ...
    override fun vx_context_read() : vx_core.Type_context {
      val output : vx_core.Type_context = vx_web_htmldoc.f_context_read()
      return output
    }
  ...
  class Class_context_write : vx_core.Class_base, Func_context_write {
    ...
    override fun vx_empty() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.e_context_write
      return output
    }

    override fun vx_type() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.t_context_write
      return output
    }
    ...
    override fun vx_context_write(context : vx_core.Type_context) : vx_core.Type_context {
      val output : vx_core.Type_context = vx_web_htmldoc.f_context_write(context)
      return output
    }
  ...
  class Class_string_from_id : vx_core.Class_base, Func_string_from_id {
    ...
    override fun vx_empty() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.e_string_from_id
      return output
    }

    override fun vx_type() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.t_string_from_id
      return output
    }
    ...
    override fun <T : vx_core.Type_any, U : vx_core.Type_any> vx_any_from_any(generic_any_1 : T, value : U) : T {
      var output : T = vx_core.f_empty(generic_any_1)
      val inputval : vx_core.Type_string = value as vx_core.Type_string
      val outputval : vx_core.Type_any = vx_web_htmldoc.f_string_from_id(inputval)
      output = vx_core.f_any_from_any(generic_any_1, outputval)
      return output
    }
    ...
    override fun vx_string_from_id(id : vx_core.Type_string) : vx_core.Type_string {
      val output : vx_core.Type_string = vx_web_htmldoc.f_string_from_id(id)
      return output
    }
  ...
  class Class_string_from_stylesheet : vx_core.Class_base, Func_string_from_stylesheet {
    ...
    override fun vx_empty() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.e_string_from_stylesheet
      return output
    }

    override fun vx_type() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.t_string_from_stylesheet
      return output
    }
    ...
    override fun <T : vx_core.Type_any, U : vx_core.Type_any> vx_any_from_any(generic_any_1 : T, value : U) : T {
      ...
      val outputval : vx_core.Type_any = vx_web_htmldoc.f_string_from_stylesheet(inputval)
      output = vx_core.f_any_from_any(generic_any_1, outputval)
      return output
    }
    ...
    override fun vx_string_from_stylesheet(stylesheet : vx_web_html.Type_stylesheet) : vx_core.Type_string {
      val output : vx_core.Type_string = vx_web_htmldoc.f_string_from_stylesheet(stylesheet)
      return output
    }
  ...
  fun f_string_from_stylesheet(stylesheet : vx_web_html.Type_stylesheet) : vx_core.Type_string {
    ...
    output = vx_core.f_let(
      ...
      vx_core.t_any_from_func.vx_fn_new({ ->
        val stylelist : vx_web_html.Type_stylelist = vx_web_html.f_styles_from_stylesheet(
          stylesheet
        )
        val text : vx_core.Type_string = vx_web_html.f_string_from_stylelist_indent(
          stylelist,
          vx_core.vx_new_int(0)
        )
        val output_1 : vx_core.Type_any = text
        output_1
      })
    )
    return output
  ...
  class Class_ui_readstate_from_uid : vx_core.Class_base, Func_ui_readstate_from_uid {
    ...
    override fun vx_empty() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.e_ui_readstate_from_uid
      return output
    }

    override fun vx_type() : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.t_ui_readstate_from_uid
      return output
    }
    ...
    override fun <T : vx_core.Type_any, U : vx_core.Type_any> vx_any_from_any(generic_any_1 : T, value : U) : T {
      var output : T = vx_core.f_empty(generic_any_1)
      val inputval : vx_core.Type_string = value as vx_core.Type_string
      val outputval : vx_core.Type_any = vx_web_htmldoc.f_ui_readstate_from_uid(inputval)
      output = vx_core.f_any_from_any(generic_any_1, outputval)
      return output
    }
    ...
    override fun vx_ui_readstate_from_uid(uid : vx_core.Type_string) : vx_core.Type_any {
      val output : vx_core.Type_any = vx_web_htmldoc.f_ui_readstate_from_uid(uid)
      return output
    }

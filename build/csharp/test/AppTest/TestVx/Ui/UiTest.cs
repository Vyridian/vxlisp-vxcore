    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          ...
          // [
            TestVx.Ui.UiTest.f_boolean_writestate_from_uiapp_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Ui.UiTest.f_string_parentuid_from_uid_testdescribe_1(context),
            TestVx.Ui.UiTest.f_string_parentuid_from_uid_testdescribe_2(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Ui.UiTest.f_ui_readstate_uiapp_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Ui.UiTest.f_ui_readstate_from_uid_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Ui.UiTest.f_ui_write_from_ui_visible_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Ui.UiTest.f_ui_from_ui_find_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Ui.UiTest.f_ui_from_ui_selected_testdescribe_1(context)
          // ]
        )
      // ]
    );

        ...
        Vx_Test.f_test(
          ...
          Vx_Collection.f_any_from_for_until_loop(
            ...
            Vx_Core.t_boolean_from_any.vx_fn_new(
              {(current_any) in
                let current : any Vx_Core.Type_int = Vx_Core.f_any_from_any(
                  Vx_Core.t_int,
                  current_any
                )
            ...
            Vx_Core.t_any_from_any.vx_fn_new(
              {(current_any) in
                ...
                var output_2 : any Vx_Core.Type_any = Vx_Core.f_plus(current, current)
                return output_2
              }
            )
          )
          ...
          Vx_Collection.f_list_from_for_end_loop(
            ...
            Vx_Core.t_any_from_int.vx_fn_new(
              {(current_any) in
                ...
                var output_1 : any Vx_Core.Type_any = Vx_Core.f_multiply(current, current)
                return output_1
              }
            )
          )
                    ...
                    [
                      Vx_Core.f_then(
                        Vx_Core.t_boolean_from_func.vx_fn_new(
                          {() in
                            var output_2 : any Vx_Core.Type_any = Vx_Type.f_is_string(value)
                              return output_2
                            }
                        ),
      ...
      [
        ...
        Vx_Test.f_test(
          ...
          Vx_Collection.f_list_from_list_join_1(
            ...
            Vx_Core.t_any_from_any.vx_fn_new(
              {(values_any) in
                let values : any Vx_Core.Type_stringlist = Vx_Core.f_any_from_any(
                  Vx_Core.t_stringlist,
                  values_any
                )

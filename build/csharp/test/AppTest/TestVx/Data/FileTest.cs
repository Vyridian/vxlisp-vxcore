    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          ...
          // [
            TestVx.Data.FileTest.f_boolean_exists_from_file_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Data.FileTest.f_boolean_write_from_file_string_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Data.FileTest.f_file_read_from_file_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Data.FileTest.f_pathfull_from_file_testdescribe_1(context),
            TestVx.Data.FileTest.f_pathfull_from_file_testdescribe_2(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.Data.FileTest.f_string_read_from_file_testdescribe_1(context)
          // ]
        )
      // ]
    );

        ...
        Vx_Test.f_test(
          ...
          Vx_Core.f_any_from_map_start_reduce(
            ...
            Vx_Core.t_any_from_any_key_value.vx_fn_new(
              {(current_any, key_any, value_any) in
                let current : any Vx_Core.Type_string = Vx_Core.f_any_from_any(
                  Vx_Core.t_string,
                  current_any
                )
          ...
          Vx_Core.f_let(
            ...
            Vx_Core.t_any_from_func.vx_fn_new(
              {() in
                ...
                let output_1 : any Vx_Core.Type_any = Vx_Core.f_plus(v1, v2)
                return output_1
              }
            )
          )

    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          ...
          // [
            TestVx.TypeTest.f_boolean_from_string_ends_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_boolean_from_string_starts_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_int_from_string_find_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_int_from_string_findkeyword_testdescribe_1(context),
            TestVx.TypeTest.f_int_from_string_findkeyword_testdescribe_2(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_int_from_string_findlast_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_is_string_testdescribe_1(context),
            TestVx.TypeTest.f_is_string_testdescribe_2(context),
            TestVx.TypeTest.f_is_string_testdescribe_3(context),
            TestVx.TypeTest.f_is_string_testdescribe_4(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_is_type_testdescribe_1(context),
            TestVx.TypeTest.f_is_type_testdescribe_2(context),
            TestVx.TypeTest.f_is_type_testdescribe_3(context),
            TestVx.TypeTest.f_is_type_testdescribe_4(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_is_type_from_any_typelist_testdescribe_1(context),
            TestVx.TypeTest.f_is_type_from_any_typelist_testdescribe_2(context),
            TestVx.TypeTest.f_is_type_from_any_typelist_testdescribe_3(context),
            TestVx.TypeTest.f_is_type_from_any_typelist_testdescribe_4(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_string_lowercase_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_string_outdent_testdescribe_1(context),
            TestVx.TypeTest.f_string_outdent_testdescribe_2(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_string_trim_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_string_uppercase_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_string_from_int_testdescribe_1(context),
            TestVx.TypeTest.f_string_from_int_testdescribe_2(context),
            TestVx.TypeTest.f_string_from_int_testdescribe_3(context),
            TestVx.TypeTest.f_string_from_int_testdescribe_4(context),
            TestVx.TypeTest.f_string_from_int_testdescribe_5(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testdescribe output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Test.f_test(
          ...
          Vx.Type.f_string_from_int(Vx.Core.c_notanumber)
        )
      // ]
    );
    return output;
    ...
    Vx.Test.Type_testdescribe output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Test.f_test(
          ...
          Vx.Type.f_string_from_int(Vx.Core.c_infinity)
        )
      // ]
    );
    return output;
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_string_from_string_end_testdescribe_1(context),
            TestVx.TypeTest.f_string_from_string_end_testdescribe_2(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_string_from_string_start_testdescribe_1(context),
            TestVx.TypeTest.f_string_from_string_start_testdescribe_2(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_string_from_string_start_end_testdescribe_1(context),
            TestVx.TypeTest.f_string_from_string_start_end_testdescribe_2(context),
            TestVx.TypeTest.f_string_from_string_start_end_testdescribe_3(context),
            TestVx.TypeTest.f_string_from_string_start_end_testdescribe_4(context),
            TestVx.TypeTest.f_string_from_string_start_end_testdescribe_5(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_string_from_stringlist_join_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.TypeTest.f_stringlist_from_string_split_testdescribe_1(context)
          // ]
        )
      // ]
    );

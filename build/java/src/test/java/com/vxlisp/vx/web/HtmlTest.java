    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          ...
          // [
            HtmlTest.f_string_from_body_indent_testdescribe_1(context),
            HtmlTest.f_string_from_body_indent_testdescribe_2(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            HtmlTest.f_string_from_div_indent_testdescribe_1(context),
            HtmlTest.f_string_from_div_indent_testdescribe_2(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            HtmlTest.f_string_from_head_indent_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            HtmlTest.f_string_from_html_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            HtmlTest.f_string_from_img_indent_testdescribe_1(context),
            HtmlTest.f_string_from_img_indent_testdescribe_2(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            HtmlTest.f_string_from_meta_indent_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            HtmlTest.f_string_from_p_indent_testdescribe_1(context),
            HtmlTest.f_string_from_p_indent_testdescribe_2(context)
          // ]
        )
      // ]
    );

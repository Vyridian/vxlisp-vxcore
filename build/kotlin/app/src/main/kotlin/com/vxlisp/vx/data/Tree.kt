...
object vx_data_tree {
  ...
  class Class_branchlist : vx_core.Class_base, Type_branchlist {
    ...
    var vx_p_list : List<vx_data_tree.Type_branch> = vx_core.vx_listimmutable(
    ...
    override fun vx_copy(vararg vals : Any) : vx_core.Type_any {
      ...
      for (valsub : Any in vals) {
        if (valsub is vx_core.Type_msgblock) {
          ...
          var subitem : vx_data_tree.Type_branch = valsub as vx_data_tree.Type_branch
          ischanged = true
          listval.add(subitem)
  ...
  class Class_leaflist : vx_core.Class_base, Type_leaflist {
    ...
    var vx_p_list : List<vx_data_tree.Type_leaf> = vx_core.vx_listimmutable(
    ...
    override fun vx_copy(vararg vals : Any) : vx_core.Type_any {
      ...
      for (valsub : Any in vals) {
        if (valsub is vx_core.Type_msgblock) {
          ...
          var subitem : vx_data_tree.Type_leaf = valsub as vx_data_tree.Type_leaf
          ischanged = true
          listval.add(subitem)
        } else if (valsub is List<*>) {
          var listunknown : List<Any> = valsub as List<Any>

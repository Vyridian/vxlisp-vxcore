...
public class CollectionTest {
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          ...
          // [
            TestVx.CollectionTest.f_minus_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_minus_1_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_any_from_for_until_loop_testdescribe_1(context)
          // ]
        )
      // ]
    );
        ...
        Vx.Test.f_test(
          ...
          Vx.Collection.f_any_from_for_until_loop(
            ...
            Vx.Core.t_boolean_from_any.vx_fn_new(
              (current_any) => {
                Vx.Core.Type_int current = Vx.Core.f_any_from_any(
                  Vx.Core.t_int,
                  current_any
                );
            ...
            Vx.Core.t_any_from_any.vx_fn_new(
              (current_any) => {
                ...
                Vx.Core.Type_any output_2 = Vx.Core.f_plus(current, current);
                return output_2;
              }
            )
          )
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_any_from_for_while_loop_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_anymap_from_struct_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_int_from_map_key_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_int_from_stringlist_find_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_is_list_testdescribe_1(context)
          // ]
        )
      // ]
    );
      ...
      // [
        ...
        Vx.Test.f_test_true(
          ...
          Vx.Collection.f_is_list(
            Vx.Core.f_empty(Vx.Core.t_stringlist)
          )
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_is_map_testdescribe_1(context)
          // ]
        )
      // ]
    );
      ...
      // [
        ...
        Vx.Test.f_test_true(
          ...
          Vx.Collection.f_is_map(
            Vx.Core.f_empty(Vx.Core.t_stringmap)
          )
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_list_from_for_end_loop_testdescribe_1(context)
          // ]
        )
      // ]
    );
      ...
      // [
        ...
        Vx.Test.f_test(
          ...
          Vx.Collection.f_list_from_for_end_loop(
            ...
            Vx.Core.t_any_from_int.vx_fn_new(
              (current_any) => {
                Vx.Core.Type_int current = Vx.Core.f_any_from_any(
                  Vx.Core.t_int,
                  current_any
                );
                Vx.Core.Type_any output_1 = Vx.Core.f_multiply(current, current);
                return output_1;
              }
            )
          )
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_list_from_list_end_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_list_from_list_filter_testdescribe_1(context)
          // ]
        )
      // ]
    );
                    ...
                    // [
                      Vx.Core.f_then(
                        Vx.Core.t_boolean_from_func.vx_fn_new(
                          () => {
                            Vx.Core.Type_any output_2 = Vx.Type.f_is_string(value);
                              return output_2;
                            }
                        ),
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_list_from_list_filtertypes_testdescribe_1(context)
          // ]
        )
      // ]
    );
  ...
  public static Vx.Test.Type_testcase f_list_from_list_flatten(Vx.Core.Type_context context) {
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      Vx.Test.t_testcase,
      // [
        ":passfail",
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_list_from_list_flatten_testdescribe_1(context)
          // ]
        )
      // ]
    );
  ...
  public static Vx.Test.Type_testdescribe f_list_from_list_flatten_testdescribe_1(Vx.Core.Type_context context) {
    Vx.Test.Type_testdescribe output = Vx.Core.vx_new(
      Vx.Test.t_testdescribe,
      // [
        ":describename",
        ...
        Vx.Test.f_test(
          ...
          Vx.Collection.f_list_from_list_flatten(
            Vx.Core.t_stringlist,
            Vx.Core.f_new(
              Vx.Core.t_intlist,
              Vx.Core.vx_new(
  ...
  public static Vx.Test.Type_testcase f_list_from_list_join(Vx.Core.Type_context context) {
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      Vx.Test.t_testcase,
      // [
        ":passfail",
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_list_from_list_join_testdescribe_1(context)
          // ]
        )
      // ]
    );
  ...
  public static Vx.Test.Type_testdescribe f_list_from_list_join_testdescribe_1(Vx.Core.Type_context context) {
    Vx.Test.Type_testdescribe output = Vx.Core.vx_new(
      Vx.Test.t_testdescribe,
      // [
        ":describename",
        ...
        Vx.Test.f_test(
          ...
          Vx.Collection.f_list_from_list_join(
            Vx.Core.t_stringlist,
            Vx.Core.f_new(
  ...
  public static Vx.Test.Type_testcase f_list_from_list_join_1(Vx.Core.Type_context context) {
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      Vx.Test.t_testcase,
      // [
        ":passfail",
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_list_from_list_join_1_testdescribe_1(context)
          // ]
        )
      // ]
    );
  ...
  public static Vx.Test.Type_testdescribe f_list_from_list_join_1_testdescribe_1(Vx.Core.Type_context context) {
    Vx.Test.Type_testdescribe output = Vx.Core.vx_new(
      Vx.Test.t_testdescribe,
      // [
        ":describename",
        ...
        Vx.Test.f_test(
          ...
          Vx.Collection.f_list_from_list_join_1(
            Vx.Core.t_stringlist,
            Vx.Core.f_new(
              Vx.Core.t_stringlistlist,
              Vx.Core.vx_new(
            ...
            Vx.Core.t_any_from_any.vx_fn_new(
              (values_any) => {
                Vx.Core.Type_stringlist values = Vx.Core.f_any_from_any(
                  Vx.Core.t_stringlist,
                  values_any
                );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_list_from_list_start_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_list_from_list_start_end_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_map_from_map_end_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_map_from_map_keys_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_map_from_map_start_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_map_from_map_start_end_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    Vx.Test.Type_testcase output = Vx.Core.vx_new(
      ...
      // [
        ...
        Vx.Core.vx_new(
          Vx.Test.t_testdescribelist,
          // [
            TestVx.CollectionTest.f_map_from_struct_testdescribe_1(context)
          // ]
        )
      // ]
    );

...
public static class Table {
  ...
  public class Class_cell : Vx.Core.Class_base, Type_cell {
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Table.Type_cell output = Vx.Core.vx_copy(
        Vx.Data.Table.e_cell,
        vals
      );
      return output;
    }
  ...
  public class Class_celllist : Vx.Core.Class_base, Type_celllist {
    ...
    public List<Vx.Data.Table.Type_cell> vx_p_list = Vx.Core.vx_listimmutable(
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Table.Type_celllist output = Vx.Core.vx_copy(
        Vx.Data.Table.e_celllist,
        vals
      );
      return output;
    }
    ...
    public override Vx.Core.Type_any vx_copy(params object[] vals) {
      ...
      foreach (object valsub in vals) {
        if (valsub is Vx.Core.Type_msgblock) {
          ...
          Vx.Data.Table.Type_cell subitem = (Vx.Data.Table.Type_cell)valsub;
          ischanged = true;
          listval.Add(subitem);
  ...
  public class Class_cellmap : Vx.Core.Class_base, Type_cellmap {
    ...
    public Vx.Core.Map<string, Vx.Data.Table.Type_cell> vx_p_map = Vx.Core.vx_mapimmutable(
      new Vx.Core.LinkedHashMap<string, Vx.Data.Table.Type_cell>()
    );
    ...
    public Vx.Core.Type_boolean vx_set(Vx.Core.Type_string name, Vx.Core.Type_any value) {
      ...
      if (false) {
        ...
        Vx.Core.Map<string, Vx.Data.Table.Type_cell> map = Vx.Core.vx_mapmutable(this.vx_p_map);
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Table.Type_cellmap output = Vx.Core.vx_copy(
        Vx.Data.Table.e_cellmap,
        vals
      );
      return output;
    }
    ...
    public override Vx.Core.Type_any vx_copy(params object[] vals) {
      ...
      Vx.Core.Map<string, Vx.Data.Table.Type_cell> mapval = Vx.Core.vx_mapmutable(value.vx_mapcell());
      string key = "";
      Vx.Core.Type_msg msg = Vx.Core.e_msg;
      Vx.Core.Type_any msgval = Vx.Core.e_any;
      foreach (object valsub in vals) {
  ...
  public class Class_field : Vx.Core.Class_base, Type_field {
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Table.Type_field output = Vx.Core.vx_copy(
        Vx.Data.Table.e_field,
        vals
      );
      return output;
    }
  ...
  public class Class_fieldlist : Vx.Core.Class_base, Type_fieldlist {
    ...
    public List<Vx.Data.Table.Type_field> vx_p_list = Vx.Core.vx_listimmutable(
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Table.Type_fieldlist output = Vx.Core.vx_copy(
        Vx.Data.Table.e_fieldlist,
        vals
      );
      return output;
    }
    ...
    public override Vx.Core.Type_any vx_copy(params object[] vals) {
      ...
      foreach (object valsub in vals) {
        if (valsub is Vx.Core.Type_msgblock) {
          ...
          Vx.Data.Table.Type_field subitem = (Vx.Data.Table.Type_field)valsub;
          ischanged = true;
          listval.Add(subitem);
        } else if (valsub is List<Vx.Core.Type_any> listany) {
          foreach (Vx.Core.Type_any item in listany) {
  ...
  public class Class_fieldmap : Vx.Core.Class_base, Type_fieldmap {
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Table.Type_fieldmap output = Vx.Core.vx_copy(
        Vx.Data.Table.e_fieldmap,
        vals
      );
      return output;
    }
  ...
  public class Class_filter : Vx.Core.Class_base, Type_filter {
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Table.Type_filter output = Vx.Core.vx_copy(
        Vx.Data.Table.e_filter,
        vals
      );
      return output;
    }
  ...
  public class Class_row : Vx.Core.Class_base, Type_row {
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Table.Type_row output = Vx.Core.vx_copy(
        Vx.Data.Table.e_row,
        vals
      );
      return output;
  ...
  public class Class_rowlist : Vx.Core.Class_base, Type_rowlist {
    ...
    public List<Vx.Data.Table.Type_row> vx_p_list = Vx.Core.vx_listimmutable(
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Table.Type_rowlist output = Vx.Core.vx_copy(
        Vx.Data.Table.e_rowlist,
        vals
      );
      return output;
    }
    ...
    public override Vx.Core.Type_any vx_copy(params object[] vals) {
      ...
      foreach (object valsub in vals) {
        if (valsub is Vx.Core.Type_msgblock) {
          ...
          Vx.Data.Table.Type_row subitem = (Vx.Data.Table.Type_row)valsub;
          ischanged = true;
          listval.Add(subitem);
        } else if (valsub is List<Vx.Core.Type_any> listany) {
          foreach (Vx.Core.Type_any item in listany) {
  ...
  public class Class_rowmap : Vx.Core.Class_base, Type_rowmap {
    ...
    public Vx.Core.Map<string, Vx.Data.Table.Type_row> vx_p_map = Vx.Core.vx_mapimmutable(
      new Vx.Core.LinkedHashMap<string, Vx.Data.Table.Type_row>()
    );
    ...
    public Vx.Core.Type_boolean vx_set(Vx.Core.Type_string name, Vx.Core.Type_any value) {
      ...
      if (false) {
        ...
        Vx.Core.Map<string, Vx.Data.Table.Type_row> map = Vx.Core.vx_mapmutable(this.vx_p_map);
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Table.Type_rowmap output = Vx.Core.vx_copy(
        Vx.Data.Table.e_rowmap,
        vals
      );
      return output;
    }
    ...
    public override Vx.Core.Type_any vx_copy(params object[] vals) {
      ...
      Vx.Core.Map<string, Vx.Data.Table.Type_row> mapval = Vx.Core.vx_mapmutable(value.vx_maprow());
      string key = "";
      Vx.Core.Type_msg msg = Vx.Core.e_msg;
      Vx.Core.Type_any msgval = Vx.Core.e_any;
      foreach (object valsub in vals) {
  ...
  public class Class_sort : Vx.Core.Class_base, Type_sort {
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Table.Type_sort output = Vx.Core.vx_copy(
        Vx.Data.Table.e_sort,
        vals
      );
      return output;
    }
  ...
  public class Class_table : Vx.Core.Class_base, Type_table {
    ...
    public override Vx.Core.Type_any vx_new(params object[] vals) {
      Vx.Data.Table.Type_table output = Vx.Core.vx_copy(
        Vx.Data.Table.e_table,
        vals
      );
      return output;
    }

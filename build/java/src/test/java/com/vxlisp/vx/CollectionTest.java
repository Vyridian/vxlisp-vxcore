    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          ...
          // [
            CollectionTest.f_minus_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_minus_1_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_any_from_for_until_loop_testdescribe_1(context)
          // ]
        )
      // ]
    );
        ...
        Test.f_test(
          ...
          Collection.f_any_from_for_until_loop(
            ...
            Core.t_boolean_from_any.vx_fn_new(
              (current_any) -> {
                final Core.Type_int current = Core.f_any_from_any(
                  Core.t_int,
                  current_any
                );
            ...
            Core.t_any_from_any.vx_fn_new(
              (current_any) -> {
                ...
                Core.Type_any output_2 = Core.f_plus(current, current);
                return output_2;
              }
            )
          )
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_any_from_for_while_loop_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_anymap_from_struct_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_int_from_map_key_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_int_from_stringlist_find_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_is_list_testdescribe_1(context)
          // ]
        )
      // ]
    );
      ...
      // [
        ...
        Test.f_test_true(
          ...
          Collection.f_is_list(
            Core.f_empty(Core.t_stringlist)
          )
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_is_map_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_list_from_for_end_loop_testdescribe_1(context)
          // ]
        )
      // ]
    );
      ...
      // [
        ...
        Test.f_test(
          ...
          Collection.f_list_from_for_end_loop(
            ...
            Core.vx_new_int(2),
            Core.vx_new_int(3),
            Core.t_any_from_int.vx_fn_new(
              (current_any) -> {
                final Core.Type_int current = Core.f_any_from_any(
                  Core.t_int,
                  current_any
                );
                Core.Type_any output_1 = Core.f_multiply(current, current);
                return output_1;
              }
            )
          )
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_list_from_list_end_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_list_from_list_filter_testdescribe_1(context)
          // ]
        )
      // ]
    );
                    ...
                    // [
                      Core.f_then(
                        Core.t_boolean_from_func.vx_fn_new(
                          () -> {
                            Core.Type_any output_2 = Type.f_is_string(value);
                              return output_2;
                            }
                        ),
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_list_from_list_filtertypes_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_list_from_list_flatten_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_list_from_list_join_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_list_from_list_join_1_testdescribe_1(context)
          // ]
        )
      // ]
    );
      ...
      // [
        ...
        Test.f_test(
          ...
          Collection.f_list_from_list_join_1(
            ...
            Core.t_any_from_any.vx_fn_new(
              (values_any) -> {
                final Core.Type_stringlist values = Core.f_any_from_any(
                  Core.t_stringlist,
                  values_any
                );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_list_from_list_start_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_list_from_list_start_end_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_map_from_map_end_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_map_from_map_keys_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_map_from_map_start_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_map_from_map_start_end_testdescribe_1(context)
          // ]
        )
      // ]
    );
    ...
    final Test.Type_testcase output = Core.vx_new(
      ...
      // [
        ...
        Core.vx_new(
          Test.t_testdescribelist,
          // [
            CollectionTest.f_map_from_struct_testdescribe_1(context)
          // ]
        )
      // ]
    );
